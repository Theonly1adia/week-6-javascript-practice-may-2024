...
function day2Part3() {
  ...
  // 3. use a math expression with the > operator to say if the statements is true or false.
  messageParagraph.innerHTML = `The Tv costs ${tvNumber}. You have ${walletNumber}. You can afford the Tv: ${walletNumber > tvNumber || walletNumber === tvNumber}`
...
function day2Part4() {
  ...
  // 1. Ask the user for data
  bank = prompt("How much do you have in your bank account?");
  // 2. convert it to a number
  bankNumber = Number(bank);

  // 3. use a math expression with the > operator to say if the statements is true or false.
  messageParagraph.innerHTML = `The rocket cost ${rocketNumber}. You have ${bankNumber}. You can afford the Rocket: ${bankNumber > rocketNumber}`;
